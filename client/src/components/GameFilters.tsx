      ...
      >
        ...
        <div>
          ...
          >
            ...
            <option value="Strategy" data-testid="category-option-strategy">
              Strategy
            </option>
            <option value="Party" data-testid="category-option-party">
              Party
            </option>
            <option value="Family" data-testid="category-option-family">
              Family
            </option>
            <option value="Cooperative" data-testid="category-option-cooperative">
              Cooperative
            </option>
            <option value="Abstract" data-testid="category-option-abstract">
              Abstract
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <div
            data-testid="player-count-filter"
